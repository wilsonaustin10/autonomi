...
export default function Home() {
  ...
  const [initialMessages, setInitialMessages] = useState<ChatMessageType[]>([
    {sender: "assistant", message: "Hello, I'm the AutonoM3 Agent Building Assistant. How can I help you today?"}
  ])
  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-4 gap-4">
        <div className="col-span-1 h-96 bg-gray-100 border border-1 p-4">
          <ChatBox initialMessages={initialMessages} />

        </div>
        <div className="col-span-3 h-96 bg-gray-100">
          Browser
        </div>
      </div>
    </div>
